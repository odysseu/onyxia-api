...
public class KeycloakUserProvider {
	...
	return (Region region) -> {
        ...
        if (region.getGroupPattern() != null) {
            Pattern pattern = Pattern.compile(region.getGroupPattern().toUpperCase());
            groups.removeIf(group -> !pattern.matcher(group.toUpperCase()).matches());
        }
